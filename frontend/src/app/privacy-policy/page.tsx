        ...
        <div className={styles.container}>
            <main className={styles.main} style={{ flexDirection: 'column', alignItems: 'flex-start', maxWidth: '900px', margin: '0 auto', padding: '4rem 2rem' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '3rem' }}>
                    ...
                    <section>
                        <h2 style={{ fontSize: '1.8rem', fontWeight: '700', marginBottom: '1.5rem', color: '#e4e4e7' }}>5. AI and Automated Processing</h2>
                        <p style={{ color: '#a1a1aa', lineHeight: '1.8', fontSize: '1.05rem' }}>
                            HireMind utilizes Artificial Intelligence (AI) and Machine Learning (ML) technologies to analyze resumes and match them with job descriptions.
                            By using our Resume Matcher features, you acknowledge that:
                        </p>
                        <ul style={{ listStyleType: 'disc', paddingLeft: '1.5rem', color: '#a1a1aa', lineHeight: '1.8', fontSize: '1.05rem', display: 'flex', flexDirection: 'column', gap: '0.5rem', marginTop: '1rem' }}>
                            <li>Your resume content is processed by automated algorithms to extract skills, experience, and other relevant data.</li>
                            <li>The &quot;Score&quot; and &quot;Fit&quot; predictions are generated by AI and are estimates only, not definitive judgments of your employability.</li>
                            <li>We strive for fairness and accuracy but AI models may occasionally produce unexpected results.</li>
                        </ul>
                    </section>

                    <section>
                        <h2 style={{ fontSize: '1.8rem', fontWeight: '700', marginBottom: '1.5rem', color: '#e4e4e7' }}>6. Third-Party Websites</h2>
                        <p style={{ color: '#a1a1aa', lineHeight: '1.8', fontSize: '1.05rem' }}>
                    ...
                    <section>
                        <h2 style={{ fontSize: '1.8rem', fontWeight: '700', marginBottom: '1.5rem', color: '#e4e4e7' }}>7. Data Security</h2>
                        <p style={{ color: '#a1a1aa', lineHeight: '1.8', fontSize: '1.05rem' }}>
